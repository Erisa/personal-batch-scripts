...
REM "C:\path\adb.exe" push "C:\meta\lineage-16.0-20190516-nightly-pioneer-signed.zip" /sdcard/meta/
...
"C:\path\adb.exe" sideload "C:\meta\lineage-16.0-20190516-nightly-pioneer-signed.zip"
